...
const RedisStorageService = require("./services/RedisStorageService");
// const InMemoryStorageService = require("./services/InMemoryStorageService"); // Альтернативное хранилище

const app = express();
const port = 3000;

const storageService = RedisStorageService;
const urlService = new UrlService(storageService);
...
app.post("/create", async (req, res) => {
    ...
    try {
        const shortUrl = await urlService.createShortUrl(originalUrl, generateShortUrl);
